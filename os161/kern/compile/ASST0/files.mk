...
sys_write.o: ${S}/userprog/sys_write.c
	${COMPILE.c} ${S}/userprog/sys_write.c
SRCS+=${S}/userprog/sys_write.c
OBJS+=sys_write.o

sys_read.o: ${S}/userprog/sys_read.c
	${COMPILE.c} ${S}/userprog/sys_read.c
SRCS+=${S}/userprog/sys_read.c
OBJS+=sys_read.o
