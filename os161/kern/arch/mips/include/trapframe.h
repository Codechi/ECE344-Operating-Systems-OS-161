...
struct trapframe {
	...
	u_int32_t tf_sp;
	u_int32_t tf_s8;
	u_int32_t tf_epc;	/* coprocessor 0 epc register */	//PC value
};
...
int md_forkentry(struct trapframe * child_tf, unsigned long converted_ptr_child_addrspace);//changed this- was void md_forkentry(struct trapframe *tf
